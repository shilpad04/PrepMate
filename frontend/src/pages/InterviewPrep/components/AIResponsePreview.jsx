...
const AIResponsePreview = ({ content }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="text-[14px] prose prose-sm max-w-none text-gray-800">
        <ReactMarkdown
...
function CodeBlock({ code, language }) {
  ...
  return (
    <div className="relative my-6 rounded-lg overflow-hidden bg-gray-50 border border-t-gray-200">
