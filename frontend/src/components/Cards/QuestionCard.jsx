...
import { LuChevronDown, LuPin, LuPinOff, LuSparkles, LuLightbulb } from "react-icons/lu";
...
const QuestionCard = ({
  ...
  return (
    <div className="bg-white rounded-lg mb-4 overflow-hidden py-4 px-5 shadow-xl shadow-gray-100/70 border border-gray-100/60 group-hover">
      <div className="flex items-start justify-between cursor-pointer">
        <div className="flex items-start gap-3.5">
          <span className="text-xs md:text-[15px] font-semibold text-gray-400 leading-[18px]">Q</span>
          <h3
            className="text-xs md:text-[14px] font-medium text-gray-800 mr-9 md:mr-20"
      ...
      >
        <div ref={contentRef} className="mt-4">
          ...
          {/* Tips */}
          {tips && tips.length > 0 && (
            <div className="mt-3 bg-amber-50 border border-amber-100 rounded-lg px-5 py-3">
              <div className="flex items-center gap-2 mb-2">
                <LuLightbulb className="text-amber-500 text-sm" />
